...
#' @export
lossCalcRWrapper <- function(datamatL, WL, H, AdjL, DL, lambdaWL, lambdaH, diffFunc) {
    .Call(`_jrSiCKLSNMF_lossCalcRWrapper`, datamatL, WL, H, AdjL, DL, lambdaWL, lambdaH, diffFunc)
}
...
#' @export
jrSiCKLSNMF <- function(datamatL, WL, H, AdjL, DL, lambdaWL, lambdaH, initsamp, suppress_warnings, diffFunc, Hconstraint = "None", Wconstraint = "None", differr = 1e-6, rounds = 1000L, display_progress = TRUE, minibatch = TRUE, batchsize = 100L, random_W_updates = TRUE, minrounds = 100L, numthreads = 1L) {
    .Call(`_jrSiCKLSNMF_jrSiCKLSNMF`, datamatL, WL, H, AdjL, DL, lambdaWL, lambdaH, initsamp, suppress_warnings, diffFunc, Hconstraint, Wconstraint, differr, rounds, display_progress, minibatch, batchsize, random_W_updates, minrounds, numthreads)
}
